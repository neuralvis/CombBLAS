...
###
# job name
#SBATCH --job-name=CombBLAS_0003
# specify its partition
#SBATCH --partition=workq
# job stdout file
#SBATCH --output=CombBLAS_0003.%J.out
# job stderr file
#SBATCH --error=CombBLAS_0003.%J.err
...
# Run combblas 
srun $COMBBLAS_BASE_DIR/_build/Applications/dobfs+tracing 31 \
